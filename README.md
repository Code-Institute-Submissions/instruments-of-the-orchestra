...
_Colour schemes generated using [coolors.co](https://coolors.co/f94144-f67584-f8961e-f9c74f-90be6d-43aab1-264653)_

I choose a bright colour scheme for the site that features both primary and secondary colours as seen in the image above. I used these colours for all the buttons that the user will interact with throughout the quiz and for various other buttons on the website. The intention of this is to grab the users attention and encourage them to interact with the website.

To then help the main content on the page stand out, I chose dark blue/navy for the background. I then took this colour and created a simple background with various music related symbols. I also used this same color for all the main text on the site.

For the main content container, I set the background colour to white and gave the container a border using the dark blue/navy colour. This helped make the container stand out from the background. I also used white for the text used in buttons as this was easier to read and also for the navigation icons used in the header and footer of the site as this helped the icons stand out from the background.
